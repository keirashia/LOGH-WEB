...
| 114 | [114_data_battle.md](114_data_battle.md) | 전투 시스템 — 함대 전투력 계산, 진형 통합, 전략/전술 전투 로직 | 🔄 설계 중 |
| 115 | [115_data_domestic.md](115_data_domestic.md) | 내정 시스템 — 수입·식량·건물 건설 로직 | 🔄 설계 완료, 구현 대기 |
| 116 | [116_data_ship_unit.md](116_data_ship_unit.md) | 함선·유닛·함대 데이터 플로우 — 컴포넌트 구조, 봉건 풀 | ✅ |
