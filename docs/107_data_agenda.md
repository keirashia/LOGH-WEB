...
> JB_R002(제국재상): 796년 기준 영구 공석. 31대 황제 오토프리트 3세 이후 관례상 결번.  
> JB_R003(국무상서): 리히텐라데 배정. 재상 대리로 사실상 제국재상 직무 수행.  
> JB_R004(내무상서): 별도 추가됨.  
> JB_R008(군무상서), JB_R009(재무상서), JB_R012(궁내상서), JB_R013(사법상서), JB_R014(전례상서) 등록됨.  
...
| `intel` (모략) | 첩보관 (intel 체인 참조) | 독립 행사, 임명권자 국방위원장 |
| `diplomacy` (외교) | 부의장 JB_F002 → 의장 JB_F001 | |

> JB_F013(통합작전본부장·시톨레) / JB_F014(우주함대사령장관·로보스) — 최고평의회 외 군직위.  
> JB_F002(부의장): 2표 효율.  
