...
export const FINANCE = {
  // 예산 항목
  BUDGET_ITEMS: {
    MILITARY:    { id:'MILITARY',    name:'군사비',    icon:'??',  desc:'함대 유지·건조·무장 비용' },
    CONSTRUCTION:{ id:'CONSTRUCTION',name:'건설비',    icon:'???', desc:'성계 기반시설 건설 비용' },
...
export const INTEL = {
  ...
  OPERATIONS: {
    ...
    ASSASSIN:  { id:'ASSASSIN',  name:'요인 암살',   icon:'???', cost:500, turns:3, successBase:0.25, desc:'적 주요 인물을 제거합니다. 발각 시 외교 문제가 됩니다.' },
  },
  ...
  PROPOSALS: {
    ...
    SURRENDER:  { id:'SURRENDER',  name:'항복 권고',   icon:'???', cost:200, desc:'약세인 적에게 항복을 권고합니다.' },
