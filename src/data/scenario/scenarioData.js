...
export const SCENARIOS = [
  ...
  { yearType:"SE", year:682, month:1, id:"SE682_1", nameKr:"페잔 자치령 창건", nameEn:"Founding of the Phezzan Dominion", nameJp:"フェザーン自治領創建",
    tags:["사실"], factions:["REH", "FPA", "PZN"], useYn:false, openPt:0, appearances:[],
    desc: [] },
   ...
   */
  {
    ...
    subTitle: "영원한 어둠 속에서",
    summary: `제국력 487년 2월. 
    라인하르트의 함대가 아스타테 성역에서 동맹군 세 함대를 각개격파한다.
    역사는 이미 정해져 있다.
    하지만 그 끝은 당신에게 달려 있다.`,
    tags: ["사실", "초심자추천"],
  ...
  {
    yearType: "SE", year: 796, month: 2, date: 11,
    id: "SE796_11",
    nameKr: "아스타테 성역 회전", nameEn: "Battle of Astarte", nameJp: "アスターテ会戦",
    subTitle: "노원수의 출정",
    summary: `원작에서는 3개 함대씩이나 참전하면서도 우주함대 사령장관인 라자르 로보스 원수가 지휘하지 않았다. 
    그러나 은영전 내 함대교전 규모를 생각하면 이는 약간 이상한 일. 이 점을 고려해 로보스 원수가 총지휘한다는 설정이다.
    동맹으로 시작해 보면 그린힐 총참모장이 로보스 원수에게 '내선의 이점을 살려 각개격파를 시도할 수 있다'며 병력 집중을 건의했으나 포크가 이를 반대하고, 로보스가 '이미 늦었다'면서 작전을 속행시킨다.`,
    tags: ["가상"], factions: ["REH", "FPA", "PZN"],
    useYn: true, showYn: false, openPt: 1000,
    appearances: ["은하영웅전설 1권 <여명편>"],
    desc: _DESC_SE796_10,
    variants: ["SE796_10", "SE796_11", "SE796_12", "SE796_13"],
  },
  {
    ...
    nameKr: "아스타테 성역 회전", nameEn: "Battle of Astarte", nameJp: "アスターテ会戦",
    subTitle: "주둔함대의 출격",
    summary: "이제르론 요새 주둔 함대가 전선에 합류한다. 추가 전력은 전황을 뒤집을 수 있을까.",
    tags: ["가상"], factions: ["REH", "FPA", "PZN"],
    useYn: true, showYn: false, openPt: 1000,
    appearances: ["은하영웅전설 1권 <여명편>"],
    desc: _DESC_SE796_10,
  ...
  },
  {
    ...
    nameKr: "아스타테 성역 회전", nameEn: "Battle of Astarte", nameJp: "アスターテ会戦",
    subTitle: "젊은 사자들",
    summary: "라인하르트와 키르히아이스, 두 젊은 장군의 첫 대규모 회전. 미래의 황제는 여기서 전설을 시작한다.",
    tags: ["가상"], factions: ["REH", "FPA", "PZN"],
    useYn: true, showYn: false, openPt: 1000,
    appearances: ["은하영웅전설 1권 <여명편>"],
    desc: _DESC_SE796_10,
  ...
  { yearType:"SE", year:796, month:5, id:"SE796_3", nameKr:"제7차 이제르론 공방전", nameEn:"", nameJp:"",
    tags:["사실"], factions:["REH","FPA","PZN"], useYn:false, openPt:0, appearances:["은하영웅전설 1권 <여명편>"],
    desc: [] },
  ...
  { yearType:"SE", year:796, month:8, id:"SE796_6", nameKr:"제국령 침공작전", nameEn:"", nameJp:"",
    tags:["사실"], factions:["REH","FPA","PZN"], useYn:false, openPt:0, appearances:["은하영웅전설 2권 <야망편>"],
    desc: [] },
  ...
  { yearType:"SE", year:798, month:1, id:"SE798_3", nameKr:"제8차 이제르론 공방전", nameEn:"Fortress vs Fortress", nameJp:"",
    tags:["사실"], factions:["REH","FPA","PZN"], useYn:false, openPt:0, appearances:["은하영웅전설 5권 <풍운편>"],
    desc: [] },
  { yearType:"SE", year:798, month:1, id:"SE798_4", nameKr:"황제 납치 사건", nameEn:"", nameJp:"",
    tags:["사실"], factions:["REH","PZN"], useYn:false, openPt:0, appearances:[],
    desc: [] },
  ...
  { yearType:"SE", year:798, month:1, id:"SE798_9", nameKr:"율리안 민츠의 페잔 탈출", nameEn:"", nameJp:"",
    tags:["사실"], factions:["FPA","PZN"], useYn:false, openPt:0, appearances:[],
    desc: [] },
  ...
  { yearType:"SE", year:799, month:4, id:"SE799_6", nameKr:"버밀리온 성역 회전", nameEn:"Battle of Vermilion", nameJp:"バーミリオン星域会戦",
    tags:["사실","초심자추천"], factions:["REH","FPA","PZN"], useYn:false, openPt:0,
    appearances:["은하영웅전설 6권 <비상편>"],
    desc: [] },
  { yearType:"SE", year:799, month:6, id:"SE799_7", nameKr:"바라트 화약", nameEn:"Treaty of Barat", nameJp:"",
    tags:["사실"], factions:["REH","FPA","PZN"], useYn:false, openPt:0, appearances:["은하영웅전설 6권 <비상편>"],
    desc: [] },
  ...
  { yearType:"SE", year:800, month:1, id:"SE800_2", nameKr:"마르 아데타 성역 회전", nameEn:"Battle of Marr-Adetta", nameJp:"",
    tags:["사실"], factions:["REH","FPA","PZN"], useYn:false, openPt:0, appearances:["은하영웅전설 8권 <난리편>"],
    desc: [] },
  ...
  { yearType:"SE", year:800, month:1, id:"SE800_6", nameKr:"페잔 폭탄테러사건", nameEn:"", nameJp:"",
    tags:["사실"], factions:["PZN"], useYn:false, openPt:0, appearances:[],
    desc: [] },
  ...
  { yearType:"SE", year:800, month:6, id:"SE800_8", nameKr:"양 웬리 암살사건", nameEn:"Assassination of Yang Wen-li", nameJp:"ヤン・ウェンリー暗殺事件",
    tags:["사실"], factions:["REH","FPA","PZN"], useYn:false, openPt:0,
  ...
  { yearType:"SE", year:801, month:1, id:"SE801_2", nameKr:"제11차 이제르론 공방전", nameEn:"", nameJp:"",
    tags:["사실"], factions:["REH","FPA","PZN"], useYn:false, openPt:0, appearances:["은하영웅전설 10권 <낙일편>"],
    desc: [] },
  ...
  { yearType:"SE", year:801, month:1, id:"SE801_8", nameKr:"벨제데 임시 황궁 습격사건", nameEn:"", nameJp:"",
    tags:["사실"], factions:["REH","PZN"], useYn:false, openPt:0, appearances:["은하영웅전설 10권 <낙일편>"],
    desc: [] },
];
