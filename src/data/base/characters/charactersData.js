...
export const CHAR_BASE = [
    ...
    desc: [
      {
        code: "Kr",
        context:
          '시리우스 공화국 초대 수상이자 지구-시리우스 전쟁의 영웅. 지휘 넘치는 지도자로 식민지 세계를 규합해 지구연방에 맞선 반지구 운동을 이끌었다. 안정적인 민주 정부를 꿈꿨으나 "앞으로 5년만 더"를 바라던 중 심장마비로 급서해, 그 죽음이 이후 3세기에 걸친 혼란의 씨앗이 됐다.',
      },
      {
        code: "En",
        context:
  ...
  // 호우드 Hawood · ホーウッド
  {
    ...
    death: "SE|833.11.02",
    // — 성향
    // brave: 후방형 지휘관이나 DNT에서 제7함대를 희생해 제13함대를 구하는 결단력을 보임
    // moral: 약탈 명령 거부, 점령지 대민 지원 추진, 부하를 위한 자기희생
    // friend: 양 웬리(145)와 순환거리 20 / 트류니히트(245)와 순환거리 80 — 동료 의식·정의감 기반의 희생
    faction: "FPA",
    idea: "100", // 자유민주공화국
    econ: "100", // 자본주의
    brave: "55", // 신중하나 결정적 순간 희생적 돌격 감행
    moral: "88", // 약탈 거부·대민 배려·부하 희생 수용
    friend: "165", // 양 웬리(145)와 근거리, 트류니히트(245)와 원거리
    /** — 능력치
     * 4 | 통솔:79  지휘:-   공격:83  방어:78  기동:71  운영:36  정보:55  육전:73  공전:85
     * 5 | 통솔:62  지휘:-   공격:78  방어:85  기동:66  운영:73  정보:63  육전:45  공전:78
     * 6 | 통솔:62  지휘:74  공격:67  방어:61  기동:65  운영:48  정보:27  육전:-   공전:-
     */
    statCmd: 72,
    statCsm: 74,
    statAtt: 55,
    ...
    point: "0",
    recommend: 0,
    desc: [{ code: "Kr", context: `자유행성동맹군 제7함대 사령관. 계급은 중장. 암릿처 회전에 참전하였으며, 전선 지휘보다 보급·대민 행정에 뛰어난 후방형 지휘관으로 평가받는다. 부하의 능력을 세심하게 파악하는 인물로, 점령지 주민과의 융화를 위해 대민 지원을 적극 추진하였다.` }],
    // — 직업
    // 중장(JB_MR004) LV0
    // — 트레잇
    // 후위의 방패(TRC_U_000550) LV1  — 아군 위기 시 돌격, 제13함대 퇴각로 확보 (DNT)
    // 청렴함(TRC_G_011) LV1          — 약탈 명령 거부, 불법 지시 불복
    // 선량함(TRC_G_017) LV2          — 부하·민간인 배려, 온화한 성품
    // 조율자(TRC_G_013) LV1          — 부하 능력 세심하게 파악, 적재적소 배치
  },
  {
    // — 기본
    code: "CH_000551",
