...
export const UNIT_SHIP_DATA = [
  ...
  // ref: https://gineipaedia.com/wiki/Imperial_battleship_(788_UC_era)
  {
    ...
    era: 788,
    nameKr: "제국 전함",
    nameEn: "Imperial Battleship (788 UC era)",
    nameJp: "帝国戦艦",
    length: 677,
    width: 179,
    height: 228,
  ...
  // ref: https://gineipaedia.com/wiki/Imperial_fast_battleship_(788_UC_era)
  {
    ...
    era: 788,
    nameKr: "제국 고속전함",
    nameEn: "Imperial Fast Battleship (788 UC era)",
    nameJp: "帝国高速戦艦",
    length: 712,
    width: 152,
    height: 219,
  ...
  // ref: https://gineipaedia.com/wiki/Imperial_cruiser_(788_UC_era)
  {
    ...
    era: 788,
    nameKr: "제국 순양함",
    nameEn: "Imperial Cruiser (788 UC era)",
    nameJp: "帝国巡洋艦",
    length: 576,
    width: 141,
    height: 144,
  ...
  // ref: https://gineipaedia.com/wiki/Imperial_destroyer_(788_UC_era)
  {
    ...
    era: 788,
    nameKr: "제국 구축함",
    nameEn: "Imperial Destroyer (788 UC era)",
    nameJp: "帝国駆逐艦",
    length: 170,
    width: 38,
    height: 47,
  ...
  // ref: https://gineipaedia.com/wiki/Imperial_carrier_(788_UC_era)
  {
    ...
    era: 788,
    nameKr: "제국 항공모함",
    nameEn: "Imperial Carrier (788 UC era)",
    nameJp: "帝国空母",
    length: 1110,
    width: 230,
    height: 320,
  ...
  // ref: https://gineipaedia.com/wiki/Imperial_transport_(788_UC_era)
  {
    ...
    era: 788,
    nameKr: "제국 수송함",
    nameEn: "Imperial Transport (788 UC era)",
    nameJp: "帝国輸送艦",
    length: 968,
    width: 521,
    height: 537,
  ...
  // ref: https://gineipaedia.com/wiki/Alliance_battleship_(788_UC_era)
  {
    ...
    era: 788,
    nameKr: "동맹 전함",
    nameEn: "Alliance Battleship (788 UC era)",
    nameJp: "同盟戦艦",
    length: 624,
    width: 65,
    height: 136.5,
  ...
  // ref: https://gineipaedia.com/wiki/Alliance_cruiser_(788_UC_era)
  {
    ...
    era: 788,
    nameKr: "동맹 순양함",
    nameEn: "Alliance Cruiser (788 UC era)",
    nameJp: "同盟巡洋艦",
    length: 372,
    width: 94.5,
    height: 74,
  ...
  // ref: https://gineipaedia.com/wiki/Alliance_destroyer_(788_UC_era)
  {
    ...
    era: 788,
    nameKr: "동맹 구축함",
    nameEn: "Alliance Destroyer (788 UC era)",
    nameJp: "同盟駆逐艦",
    length: 208,
    width: 44.5,
    height: 47,
