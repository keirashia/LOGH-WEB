...
export const STAR_SYSTEMS = [
  ...
  //     좀 더 자연스럽게 분산)
  {
    ...
    x: 200,
    y: 290,
    desc: "레자빅(레사비크) 성계. 양 웬리 원수 모살미수사건의 전조곡이 울린 장소. 여기서 벌어진 함선 탈취 사건으로 메르카츠 생존설이 떠돌았다. 케림(y:190)과 버밀리온(y:390) 사이, 12시·6시 방향 중간에 배치.",
  },
  {
    code: "230090",
    name: [
    ...
    x: 130,
    y: 390,
    desc: "포리슨 성역. 버밀리온 성역 회전이 마무리될 무렵 빌리바르트 요아힘 폰 메르카츠 제독이 도피하여 거점으로 사용한 다얀 칸 기지가 있던 곳. 버밀리온(200,390)의 9시 방향, 바라트(70,320)의 4시 방향.",
  },
  {
    code: "230091",
    name: [
  ...
  /** 230092_PREVDO
   *  위치 : 바라투르프(230007) 2시, 샨다르아(230049) 6시, 페잔(230042) 10시
   *  연결 : 230034_LUNBINI
   *        230042_PHEZZAN
   *  행성 : 슈바라(JL-77 기지) */
  {
    ...
    x: 590,
    y: 710,
    desc: `가스행성 4개로 구성, 슬라브 군신 이름을 딴 천체들이 많다. 행성 슈바라에 JL-77 기지가 설치되었다.`,
  },
  {
    code: "230093",
    name: [
