...
export const JOBS = [
  ...
  {
    id: 'JB_R006', nameKr: '우주함대사령장관', nameEn: 'Fleet Operations Commander',
    category: 'military', faction: 'REH',
    effects: { CMD: 10, MMP: 10 },
    canCommand: true, canGovern: true,
    expToNext: null, nextJob: null,
    desc: '은하제국 우주함대 최고 사령관.',
  },
  {
    id: 'JB_R007', nameKr: '통수본부총장', nameEn: 'Chief of the Supreme Command',
    category: 'military', faction: 'REH',
    effects: { MNG: 8, MMP: 8 },
    canCommand: false, canGovern: true,
    expToNext: null, nextJob: null,
  ...
  {
    id: 'JB_F004', nameKr: '법질서위원장', nameEn: 'Chairman of Law and Order Committee',
    category: 'political', faction: 'FPA',
    effects: { MMP: 7, INF: 5 },
    canCommand: false, canGovern: true,
    expToNext: null, nextJob: null,
  ...
  {
    id: 'JB_F005', nameKr: '천연자원위원장', nameEn: 'Chairman of Natural Resources Committee',
    category: 'political', faction: 'FPA',
    effects: { MMP: 7, MNG: 5 },
    canCommand: false, canGovern: true,
    expToNext: null, nextJob: null,
  ...
  {
    id: 'JB_F006', nameKr: '인적자원위원장', nameEn: 'Chairman of Human Resources Committee',
    category: 'political', faction: 'FPA',
    effects: { MMP: 7, CSM: 5 },
    canCommand: false, canGovern: true,
    expToNext: null, nextJob: null,
  ...
  {
    id: 'JB_F007', nameKr: '경제개발위원장', nameEn: 'Chairman of Economic Development Committee',
    category: 'political', faction: 'FPA',
    effects: { MMP: 7, MNG: 5 },
    canCommand: false, canGovern: true,
    expToNext: null, nextJob: null,
  ...
  {
    id: 'JB_F008', nameKr: '지역사회개발위원장', nameEn: 'Chairman of Community Development Committee',
    category: 'political', faction: 'FPA',
    effects: { MMP: 7 },
    canCommand: false, canGovern: true,
    expToNext: null, nextJob: null,
  ...
  {
    id: 'JB_F009', nameKr: '정보교통위원장', nameEn: 'Chairman of Information and Transportation Committee',
    category: 'political', faction: 'FPA',
    effects: { MMP: 7, INF: 5 },
    canCommand: false, canGovern: true,
    expToNext: null, nextJob: null,
  ...
  {
    id: 'JB_F010', nameKr: '외교위원장', nameEn: 'Chairman of Foreign Affairs Committee',
    category: 'political', faction: 'FPA',
    effects: { MMP: 7, CSM: 5 },
    canCommand: false, canGovern: true,
    expToNext: null, nextJob: null,
  ...
  {
    id: 'JB_F011', nameKr: '교육위원장', nameEn: 'Chairman of Education Committee',
    category: 'political', faction: 'FPA',
    effects: { MMP: 7 },
    canCommand: false, canGovern: true,
    expToNext: null, nextJob: null,
  ...
  {
    id: 'JB_F012', nameKr: '최고평의회서기', nameEn: 'Secretary of the High Council',
    category: 'political', faction: 'FPA',
    effects: { MMP: 3 },
    canCommand: false, canGovern: true,
    expToNext: null, nextJob: null,
